...
// Match the pdata version required by Prometheus; the old xpdata uses removed pooling APIs.
replace go.opentelemetry.io/collector/pdata/xpdata => go.opentelemetry.io/collector/pdata/xpdata v0.148.0
