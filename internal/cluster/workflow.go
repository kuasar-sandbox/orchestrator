...
// WorkflowFinalizationIntent is the durable Registry-side retry intent for an
// exact node-local Admission/dedupe record. Object IDs remain the business
// identity; this record introduces no generic execution identity.
