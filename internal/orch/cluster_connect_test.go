		...
		t.Run(test.name, func(t *testing.T) {
			...
			sb := &types.Sandbox{
				...
				State:      types.StatePaused, ResumeSource: types.ResumeSource{
					SandboxRef: map[types.ResumeSourceKind]string{types.ResumeSourceSnapshot: "manifest://eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"}[test.sourceKind],
